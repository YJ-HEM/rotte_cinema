...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    private static final String TAG = "MyFirebaseMsgService"; //푸시 알림 설정
    private String title = "";
    private String body = "";
    private String color = ""; // [START receive_message]
    ...
    private void scheduleJob() {
        ...
        dispatcher.schedule(myJob); // [END dispatch_job]
    }
    ...
    private void sendNotification() {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, channelId).setSmallIcon(R.drawable.ic_logo_r).setContentTitle(title).setContentText(body).setColor(Color.parseColor(color)).setAutoCancel(true).setSound(defaultSoundUri).setContentIntent(pendingIntent).setPriority(Notification.PRIORITY_HIGH);
